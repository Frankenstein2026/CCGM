...
class ResidualDenseBlock_5C(nn.Module):
    def __init__(self, nc=128, gc=8, outc=128, kernel_size=3, stride=1, padding=1, bias=True, mode='CR', negative_slope=0.2):
        ...
        self.conv5 = conv(nc+4*gc, outc, kernel_size, stride, padding, bias, mode[:-1], negative_slope)
